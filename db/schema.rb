...
ActiveRecord::Schema.define(version: 20150503032154) do
  ...
  add_index "attends", ["guest_id"], name: "index_attends_on_guest_id", using: :btree
  ...
  add_index "owns", ["event_id"], name: "index_owns_on_event_id", using: :btree
  add_index "owns", ["manager_id"], name: "index_owns_on_manager_id", using: :btree
